...
import net.school.web.italker.push.bean.api.account.AccountRspModel;
import net.school.web.italker.push.bean.api.account.LoginModel;
import net.school.web.italker.push.bean.api.account.RegisterModel;
