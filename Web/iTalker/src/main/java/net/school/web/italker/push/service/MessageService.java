...
import net.school.web.italker.push.bean.api.message.MessageCreateModel;
import net.school.web.italker.push.bean.card.MessageCard;
import net.school.web.italker.push.bean.db.Group;
import net.school.web.italker.push.bean.db.Message;
import net.school.web.italker.push.bean.db.User;
import net.school.web.italker.push.factory.GroupFactory;
import net.school.web.italker.push.factory.MessageFactory;
